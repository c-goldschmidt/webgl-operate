...
import auxiliaries = require('../auxiliaries');
...
class VertexAttribute {
    static fromGltf(accessor: GLTF.Accessor, byteStride: number | undefined, buffer: Buffer): VertexAttribute {
        ...
        if (gPrimitive.indices !== undefined) {
            ...
            if (prim.indexType === gl.UNSIGNED_INT && context.isWebGL1) {
                if (context.supportsElementIndexUint) {
                    // TODO: store extension due to minifier issue - where?
