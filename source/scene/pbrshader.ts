...
export class PbrShader {
    ...
    // storing extensions to avoid problems with minifiers (-> may remove unused getter usages)
    shaderTextureLOD: any;
    standardDerivatives: any;
